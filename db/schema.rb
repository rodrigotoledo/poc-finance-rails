...
ActiveRecord::Schema[8.1].define(version: 2026_04_29_172000) do
  ...
  create_table "credit_operations", force: :cascade do |t|
    ...
    t.index ["idempotency_key"], name: "index_credit_operations_on_idempotency_key", unique: true, where: "(discarded_at IS NULL)"
  ...
  create_table "exports", force: :cascade do |t|
    ...
    t.index ["idempotency_key"], name: "index_exports_on_idempotency_key", unique: true
  ...
  create_table "financial_assets", force: :cascade do |t|
    ...
    t.index ["idempotency_key"], name: "index_financial_assets_on_idempotency_key", unique: true
  ...
  create_table "funds", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["idempotency_key"], name: "index_funds_on_idempotency_key", unique: true
    t.index ["status"], name: "index_funds_on_status"
  end

  create_table "idempotency_requests", force: :cascade do |t|
    t.datetime "completed_at"
    t.datetime "created_at", null: false
    ...
    t.datetime "updated_at", null: false
    t.index ["completed_at"], name: "index_idempotency_requests_on_completed_at"
    t.index ["key", "method", "path"], name: "index_idempotency_requests_key_method_path", unique: true
  end
  ...
  create_table "import_batches", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["idempotency_key"], name: "index_import_batches_on_idempotency_key", unique: true
  ...
  create_table "investment_accounts", force: :cascade do |t|
    ...
    t.index ["idempotency_key"], name: "index_investment_accounts_on_idempotency_key", unique: true
  ...
  create_table "investment_risks", force: :cascade do |t|
    ...
    t.index ["idempotency_key"], name: "index_investment_risks_on_idempotency_key", unique: true
  ...
  create_table "investments", force: :cascade do |t|
    ...
    t.index ["idempotency_key"], name: "index_investments_on_idempotency_key", unique: true, where: "(discarded_at IS NULL)"
  ...
  create_table "investors", force: :cascade do |t|
    ...
    t.index ["idempotency_key"], name: "index_investors_on_idempotency_key", unique: true, where: "(discarded_at IS NULL)"
  ...
  create_table "originators", force: :cascade do |t|
    ...
    t.index ["idempotency_key"], name: "index_originators_on_idempotency_key", unique: true, where: "(discarded_at IS NULL)"
  ...
  create_table "receivables", force: :cascade do |t|
    ...
    t.index ["idempotency_key"], name: "index_receivables_on_idempotency_key", unique: true, where: "(discarded_at IS NULL)"
  ...
  create_table "regulatory_gaps", force: :cascade do |t|
    ...
    t.index ["idempotency_key"], name: "index_regulatory_gaps_on_idempotency_key", unique: true, where: "(discarded_at IS NULL)"
  end
  ...
  create_table "risk_assessments", force: :cascade do |t|
    ...
    t.index ["idempotency_key"], name: "index_risk_assessments_on_idempotency_key", unique: true
